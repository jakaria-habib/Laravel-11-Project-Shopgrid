    ...
    <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
            <h4 class="d-flex justify-content-between align-items-center mb-3">
                ...
                <span class="badge badge-secondary badge-pill">{{ count($cart_products) }}</span>
            </h4>
            ...
            <ul class="list-group mb-3">
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0">{{ $cart_product->name }} - ({{ $cart_product->price }} * {{ $cart_product->qty }})</h6>
                        <small class="text-muted">Brief description</small>
                    </div>
                    <span class="text-muted">{{ number_format($cart_product->total) }}</span>
                </li>
                    @php( $sum = $sum + $cart_product->total )
                @endforeach

                <li class="list-group-item d-flex justify-content-between">
                    <span>Sub Total Amount (BDT)</span>
                ...
                <li class="list-group-item d-flex justify-content-between">
                    ...
                    <strong>{{ number_format($shipping_cost) }}</strong>
                </li>
                @if( session()->get('coupon_amount'))
                <li class="list-group-item d-flex justify-content-between">
                    <span>Discount Amount</span>
                    <strong>{{ number_format( session()->get('coupon_amount')) }}</strong>
                </li>
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" id="address" name="address" placeholder="1234 Main St" required>{{ $address }}</textarea>
                    <div class="invalid-feedback">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" value="1207" class="form-control" id="zip" placeholder="" required>
                        <div class="invalid-feedback">
                            Zip code required.
                        </div>
                    </div>
