...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        {
            $post_data['value_a'] = session()->get('coupon_amount');
            $post_data['value_b'] = session()->get('coupon_name');
        }
        else
        {
            $post_data['value_a'] =0;
            $post_data['value_b'] = null;
        }
        ...
        $update_product = DB::table('orders')
            ...
            ->updateOrInsert([
                ...
                'shipping_amount'   => session()->get('shipping_cost'),
                'discount_amount'   => $post_data['value_a'] ,
                'coupon_name'       => $post_data['value_b'],
                ...
                'currency'          => $post_data['cus_country'],
